...
from volsurfs.params.train_params import TrainParams
...
from volsurfs.callbacks.callback_utils import create_callbacks
from volsurfs.callbacks.training_state import TrainingState
from volsurfs.params.hyper_params import get_method_hyper_params
from volsurfs.utils.training import (
    estimate_test_loss,
    save_checkpoints,
...
from volsurfs.utils.visualization import (
...
def main(device="cuda"):
    ...
    if paths["teacher_checkpoints"] is not None:
        ...
        # teacher method
        from volsurfs.methods.nerf import NeRF
